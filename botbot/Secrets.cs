namespace botbot
{
    public sealed class Secrets
    {
        ...
        public const string SoundCloudPassword = "";
        ...
        public const string SpotifyNewReleasesClientId = "";
        public const string SpotifyNewReleasesClientSecret = "";
        public const ushort GPMServerPortNumber = 5000;
